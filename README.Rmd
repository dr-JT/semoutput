...
![alt text](https://github.com/dr-JT/semoutput/blob/master/vignettes/ModelFit_CFA.png)

### CFA Output

![alt text](https://github.com/dr-JT/semoutput/blob/master/vignettes/Output_CFA.png)

### SEM Output

![alt text](https://github.com/dr-JT/semoutput/blob/master/vignettes/Output_SEM.png)


### Model Diagram

![alt text](https://github.com/dr-JT/semoutput/blob/master/vignettes/DiagramModel_SEM.png)

### Correlation Matrix

![alt text](https://github.com/dr-JT/semoutput/blob/master/vignettes/CorrelationMatrix.png)
