...
![alt text](https://github.com/dr-JT/semoutput/blob/master/man/ModelFit_CFA.png)

### CFA Output

![alt text](https://github.com/dr-JT/semoutput/blob/master/man/Output_CFA.png)

### SEM Output

![alt text](https://github.com/dr-JT/semoutput/blob/master/man/Output_SEM.png)


### Model Diagram

![alt text](https://github.com/dr-JT/semoutput/blob/master/man/DiagramModel_SEM.png)

### Correlation Matrix

![alt text](https://github.com/dr-JT/semoutput/blob/master/man/CorrelationMatrix.png)
