...
- The "Session Info" tab contains information about the current R Session including what packages were loaded, how to cite the `lavaan` package and how to cite the R statistical software.
